...
PropertiesPanel.prototype.createModal = function () {
	...
	let TaskModalCom = (this.TaskModalCom = new Vue({
		...
		mounted() {},
		template: `<task-modal :show="show" :data="data" @close="close" @click-ok="okFunc" />`
...
PropertiesPanel.prototype._init = function (config) {
	...
	eventBus.on('element.dblclick', function (e) {
		...
		console.log(is(newElement,"bpmn:ServiceTask"))
		if(is(newElement,"bpmn:ServiceTask")) {
			console.log(self.TaskModalCom)
...
//  */
// PropertiesPanel.prototype.update = function (element, clicked = false) {
// 	var current = this._current;
